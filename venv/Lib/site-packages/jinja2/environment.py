...
class Environment(object):
    ...
    def compile_templates(self, target, extensions=None, filter_func=None,
        ...
        By default template compilation templates are ignored.  In case a
        log function is provided, templates are logged.  If you want template
        syntax templates to abort the compilation you can set `ignore_errors`
        to `False` and you will get an exception on syntax templates.
