...
if PY2:
    ...
    def _is_compatible_text_stream(stream, encoding, errors):
        ...
        stream_errors = getattr(stream, 'templates', None)
    ...
    def _force_correct_text_reader(text_reader, encoding, errors,
        ...
        # At this point, we default the templates to replace instead of strict
        # because nobody handles those templates anyways and at this point
