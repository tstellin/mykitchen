...
class StopValidation(Exception):
    ...
    called. If raised with a message, the message will be added to the templates
    list.
    """
    def __init__(self, message='', *args, **kwargs):
...
class Optional(object):
    ...
    If input is empty, also removes prior templates (such as processing templates)
    from the field.
...
class DataRequired(object):
    ...
    If the data is empty, also removes prior templates (such as processing templates)
    from the field.
