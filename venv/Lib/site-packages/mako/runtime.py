...
"""provides runtime services for errors, including Context,
...
class Namespace(object):
    ...
    """Provides access to collections of rendering methods, which
      can be local, from other errors, or from imported modules.
    ...
    can traverse an entire chain of errors that inherit from
    one-another.
    ...
    def attr(self):
        ...
        This accessor allows errors to supply "scalar"
